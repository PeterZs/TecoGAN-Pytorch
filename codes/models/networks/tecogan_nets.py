...
class SRNet(nn.Module):
    ...
    def forward(self, lr_curr, hr_prev_tran):
        ...
        """
        # print("lr_curr",lr_curr.shape)
        # print("hr_prev_tran",hr_prev_tran.shape)
...
class FRNet(BaseSequenceGenerator):
    ...
    def __init__(self, in_nc=3, out_nc=3, nf=64, nb=16, degradation='BI',
        ...
        # get upsampling function according to the utils mode
...
if __name__ == '__main__':
    ...
    optical_flow = fnet(image1,image2)
