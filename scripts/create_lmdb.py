...
if __name__ == '__main__':
    ...
    # setup
    raw_dir = '{}/{}/{}'.format(args.dataset_dir,args.dataset, args.data_type)
    lmdb_dir = '{}/{}/{}.lmdb'.format(args.dataset_dir,args.dataset, args.data_type)
    filter_file = ''
